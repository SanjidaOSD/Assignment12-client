        ...
        <div>
            ...
            <div className="md:mt-24">
                <div className="card shrink-0 w-full h-full max-w-sm mx-auto rounded-xl shadow-2xl  p-4">
                    ...
                    <Link to='/emailLogin'><button onClick={onSubmit} className="btn w-full bg-gray-50 flex hover:bg-gray-100 duration-200 justify-center items-center gap-4 py-2 my-1 rounded-lg">Log in with Email</button></Link>
