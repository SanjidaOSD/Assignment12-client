        ...
        <div>
            ...
            <div>
                <form onSubmit={handleSubmit(handleCreateCampaign)}>
                    ...
                    <input className="block px-5 py-2 bg-blue-50 rounded-md w-full my-1" type="file" placeholder="Donation Pet Image" name="donationImage" {...register("donationImage", { required: true })} />
                    ...
                    <textarea rows={5} className="block px-5 py-2 bg-blue-50 rounded-md w-full my-1" type="text" placeholder="Long Description" name="longDescription" {...register("longDescription", { required: true })} />
