    ...
    return (
        <div>
            ...
            <div className='p-5 bg-blue-50 rounded-b-lg shadow-md'>
                ...
                <div>
                    <Link to={`/campaign-details/${_id}`}><button className='w-full block mt-5 hover:text-white hover:bg-gray-700 duration-300 bg-blue-50 px-5 text-center py-2 rounded-lg text-lg font-semibold'> See Details </button></Link>
                </div>
            </div>
        </div>
    );
